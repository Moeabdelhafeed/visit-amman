...
<section class="container max-w-[1280px]  md:px-20    mx-auto text-web-brown text-center lg:px-50 px-4 pt-16" v-if="content?.intro">
  <div class=" mx-auto">
    ...
    <div v-motion-slide-visible-once-bottom class="flex  flex-col">
      ...
      <p v-html="content?.intro?.body.replace(/\n/g,'<br>')" class="mt-6 text-web-brown/70 order-2 text-base leading-relaxed w-full">
      </p>
    </div>
  </div>
</section>
...
<!-- cards section -->
<section v-motion-slide-visible-once-bottom class="container max-w-[1280px]  md:px-20  lg:px-10  mx-auto text-web-brown px-4 " v-if="content?.intro">
  <div class="mx-auto">
    <!-- Section Header -->
    <div class="text-center mb-16">
      <h2 class="text-2xl font-bold text-web-brown mb-6">
        Why Visit Amman?
      </h2>
      <!-- Decorative Line -->
...
<section v-motion-slide-visible-once-bottom class="container max-w-[1280px]  md:px-20  lg:px-10  mx-auto text-web-brown px-4" v-if="content?.first">
  <div class="xl:grid flex flex-col xl:grid-cols-2 gap-10 items-center">
    <!-- Text Content -->
    <div class="flex flex-col order-2 xl:order-1">
      <h2 class="font-bold order-1 text-2xl mb-4">
        {{ content?.first?.title }}
      </h2>
      <p v-html="content?.first?.body.replace(/\n/g,'<br>')" class="mt-6 text-web-brown/70 order-2 leading-relaxed text-base">
      </p>
    </div>
...
<section v-motion-slide-visible-once-bottom class="container max-w-[1280px]  md:px-20  lg:px-10  mx-auto text-web-brown px-4 mt-20" v-if="content?.second">
  <div class="xl:grid flex flex-col xl:grid-cols-2 gap-8 items-center">
    ...
    <div class="flex flex-col order-2 xl:order-2">
      ...
      <p v-html="content?.second?.body.replace(/\n/g,'<br>')" class="mt-6 order-2 text-web-brown/70 leading-relaxed text-base">
      </p>
    </div>
  </div>
</section>
...
<!-- Divider -->
<hr class="container max-w-[1280px]  md:px-20  lg:px-10  mx-auto my-8 xl:my-16 border-gray-200">

<!-- 360 Virtual Tour Section -->
<section v-motion-slide-visible-once-bottom class="container max-w-[1280px]  md:px-20  lg:px-10  mx-auto text-web-brown px-4 ">
  <div class="mx-auto">
    <!-- Section Header -->
    ...
    <!-- Additional Info -->
    <div class="mt-8 xl:mt-12 text-center text-base">
